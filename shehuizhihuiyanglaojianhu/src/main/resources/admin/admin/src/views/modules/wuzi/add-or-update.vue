        ...
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='laoren'">
                    <el-form-item class="select" v-if="type!='info'"  label="老人信息" prop="laorenId">
                        <el-select v-model="ruleForm.laorenId" :disabled="ro.laorenId" filterable placeholder="请选择老人信息" @change="laorenChange">
                            <el-option
                ...
                <el-col :span="12"  v-if="sessionTable !='laoren' ">
                    <el-form-item class="input" v-if="type!='info'"  label="老人年纪" prop="laorenAge">
                        <el-input v-model="laorenForm.laorenAge"
                                  placeholder="老人年纪" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="老人年纪" prop="laorenAge">
                            <el-input v-model="ruleForm.laorenAge"
                                      placeholder="老人年纪" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='laoren' ">
                    <el-form-item class="input" v-if="type!='info'"  label="老人身体状态" prop="laorenValue">
                        <el-input v-model="laorenForm.laorenValue"
                                  placeholder="老人身体状态" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="老人身体状态" prop="laorenValue">
                            <el-input v-model="ruleForm.laorenValue"
                                      placeholder="老人身体状态" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='laoren' ">
                    <el-form-item class="input" v-if="type!='info'"  label="是否有疾病" prop="jibingValue">
                        <el-input v-model="laorenForm.jibingValue"
                                  placeholder="是否有疾病" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="是否有疾病" prop="jibingValue">
                            <el-input v-model="ruleForm.jibingValue"
                                      placeholder="是否有疾病" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
            ...
            <input id="laorenId" name="laorenId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="数量" prop="wuziNumber">
                       <el-input v-model="ruleForm.wuziNumber"
                                 placeholder="数量" clearable  :readonly="ro.wuziNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="数量" prop="wuziNumber">
                           <el-input v-model="ruleForm.wuziNumber"
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item class="upload" v-if="type!='info' && !ro.wuziPhoto" label="发票上传" prop="wuziPhoto">
                        <file-upload
                            tip="点击上传发票上传"
                            action="file/upload"
                            :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.wuziPhoto" label="发票上传" prop="wuziPhoto">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   wuziPhoto: [
                              { required: true, message: '发票上传不能为空', trigger: 'blur' },
                          ],
                }
            };
        },
