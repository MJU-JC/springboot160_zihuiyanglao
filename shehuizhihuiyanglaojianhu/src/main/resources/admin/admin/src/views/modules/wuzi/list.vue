            ...
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                    ...
                    <el-form-item :label="contents.inputTitle == 1 ? '老人名称' : ''">
                        <el-input prefix-icon="el-icon-search" v-model="searchForm.laorenName" placeholder="老人名称" clearable></el-input>
                    </el-form-item>
                    ...
                    <el-form-item :label="contents.inputTitle == 1 ? '老人身体状态' : ''">
                        <el-select v-model="searchForm.laorenTypes" placeholder="请选择老人身体状态">
                            <el-option label="=-请选择-=" value=""></el-option>
                            <el-option
                    ...
                    <el-form-item :label="contents.inputTitle == 1 ? '是否有疾病' : ''">
                        <el-select v-model="searchForm.jibingTypes" placeholder="请选择是否有疾病">
                            <el-option label="=-请选择-=" value=""></el-option>
                            <el-option
                                    v-for="(item,index) in jibingTypesSelectSearch"
                                    v-bind:key="index"
                                    :label="item.indexName"
                                    :value="item.codeIndex">
                                <!--lable是要展示的名称-->
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/shehuizhihuiyanglaojianhu/upload/wuziMuBan.xls"
                        >批量导入物资申请数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('wuzi','导入导出')"
    ...
    //当前表下拉框搜索条件
        ...
        methods: {
            ...
            getDataList() {
                ...
                if (this.searchForm.laorenTypes!= '' && this.searchForm.laorenTypes!= undefined) {
                    params['laorenTypes'] = this.searchForm.laorenTypes
                }
                     
                if (this.searchForm.jibingTypes!= '' && this.searchForm.jibingTypes!= undefined) {
                    params['jibingTypes'] = this.searchForm.jibingTypes
                }
                ...
                this.$http({
                    url: "dictionary/page?dicCode=laoren_types&page=1&limit=100",
                    method: "get",
                    page: 1,
                    limit: 100,
                }).then(({data}) => {
                ...
                this.$http({
                    url: "dictionary/page?dicCode=jibing_types&page=1&limit=100",
                    method: "get",
                    page: 1,
                    limit: 100,
                }).then(({data}) => {
                    if(data && data.code === 0){
                        this.jibingTypesSelectSearch = data.data.list;
                    }
                });
                //查询当前表搜索条件所有列表
                //填充下拉框选项
